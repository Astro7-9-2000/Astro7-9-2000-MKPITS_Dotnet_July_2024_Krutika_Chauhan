            ...
            <form action="forms/contact.php" method="post" role="form" class="php-email-form">
              <div class="form-row">
                ...
                <div class="col-md-6 form-group">
                  <%--<input type="email" class="form-control" name="email" id="email" placeholder="Your Email" data-rule="email" data-msg="Please enter a valid email" />--%>
                    ...
                    <asp:RequiredFieldValidator ControlToValidate = "Txt" ForeColor = "Red" SetFocusOnError = "true" Display = "Dynamic" ID = RequiredFieldValidator2 runat="server" ErrorMessage = "Name is Required"></asp:RequiredFieldValidator>
                 <%-- <div class="validate"></div>--%>
                </div>
              </div>
              ...
              <div class="form-group">
                <%--<textarea class = "form-control" name = "message" rows = "5" data-rule = "required" data-msg = "Please write something for us" placeholder = "Message"></textarea>--%>
                  <asp:TextBox ID = "TxtMsg" TextMode = "MultiLine" Columns = "50"  Rows = "5" class = "form-control" runat="server"></asp:TextBox>
               <%-- <div class="validate"></div>--%>
              </div>
              <%--<div class="mb-3">
